...
async function register() {
  if (
    ...
    errorMsg.value = 'Incorrect values'
      ...
      <div class="md:flex w-full">
        ...
        <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
          ...
          <div>
            ...
            <div class="h-8 m-0">
              <div v-if="errorAlert" class="inline-block align-baseline text-sm text-red-600 ml-2">
                {{ errorMsg }}
              </div>
            </div>
            <div class="flex -mx-3">
        ...
        <div
          v-if="successAlert"
          class="fixed mb-4 left-1/2 transform -translate-x-1/2 top-56 bg-green-100 border border-green-400 text-green-700 px-4 py-2 rounded"
          role="alert"
        >
          <svg
